...
import type { Store, World } from "../domain/types.js";
...
function growEarthFood(world: World): void {
...
function refineUranusFuel(world: World): void {
...
function firstStore(world: World, planetId: string): Store | null {
